...
const Loader = () => {
  ...
  const containerUp = {
    ...
    show: {
      clipPath: "polygon(0 50%, 100% 48%, 100% 48%, 0 50%)",
      display: "none",
      transition: {
        delay: 3.5,
        duration: 0.5,
        ease: "easeInOut",
        onComplete: () => setIsLoading(false), // Set loading selesai
      },
    },
  };
  ...
  return (
    <motion.div
      id="loader"
      className="bg-primaryLight dark:bg-primaryDark h-screen absolute inset-0 overflow-hidden z-50"
    ...
    >
      <motion.section className="flex flex-col justify-center items-center gap-3 w-full h-full -translate-y-32">
        <h1 className="text-primaryDark dark:text-primaryLight text-3xl md:text-5xl font-playfair uppercase">Gesly Ardiansyah</h1>
